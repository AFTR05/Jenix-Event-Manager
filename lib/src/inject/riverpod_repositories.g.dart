...
part of 'riverpod_repositories.dart';
...
String _$authenticationRepositoryHash() =>
    r'ebe3e03f224ecd6fc49afb3f528993fe4adad3b3';
...
String _$campusRepositoryHash() => r'87432fa622da1fba4e9da1cd04fc1b3f2a7d82e6';

/// See also [campusRepository].
@ProviderFor(campusRepository)
final campusRepositoryProvider = AutoDisposeProvider<CampusRepository>.internal(
  campusRepository,
  name: r'campusRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$campusRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef CampusRepositoryRef = AutoDisposeProviderRef<CampusRepository>;
String _$roomRepositoryHash() => r'7c40c1f336f57778a79887c6bddffa8361fe4fab';
