...
final authenticationUsecaseProvider =
    AutoDisposeProvider<AuthenticationUsecase>.internal(
...
final campusUsecaseProvider = AutoDisposeProvider<CampusUsecase>.internal(
  campusUsecase,
  name: r'campusUsecaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$campusUsecaseHash,
  dependencies: null,
...
final roomUsecaseProvider = AutoDisposeProvider<RoomUsecase>.internal(
  roomUsecase,
  name: r'roomUsecaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$roomUsecaseHash,
  dependencies: null,
